        ...
        <div className="h-full px-10 py-5 w-full overflow-hidden">
            ...
            <section className="w-full h-9/10 mt-5">
                                ...
                                >
                                    <div className="flex items-center justify-start mb-3 gap-x-3">
                                        <img
                                            ...
                                            src={
                                                mentor.avatar.url === ""
                                                    ? `https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRPl-fZZ_0aKe6BMN-wtnUxHrmIDLOX3_em2Q&s`
                                                    : mentor.avatar.url
                                            }
                                            alt="img"
                                        />
                ...
                {selected === "mentees" && (
                    <div
                        onClick={blockUser}
                        className="flex items-start justify-start flex-wrap gap-x-5 gap-y-5 w-full h-full overflow-y-auto"
                    >
